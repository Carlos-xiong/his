...
func main() {
	...
	// err = QueryCars(context.Background(), cars)
	// if err != nil {
...
func CreateUser(ctx context.Context, client *ent.Client) (*ent.User, error) {
	u, err := client.User.
		Create().
		SetAge(30).
		SetName("a8m").SetEmail("a8m@entgo.io").
		Save(ctx)
	if err != nil {
...
func CreateGraph(ctx context.Context, client *ent.Client) error {
	...
	a8m, err := client.User.
		Create().
		SetAge(30).
		SetName("Ariel").SetEmail("ariel@entgo.io").
		Save(ctx)
	if err != nil {
		return err
	}
	neta, err := client.User.
		Create().
		SetAge(28).
		SetName("Neta").SetEmail("neta@entgo.io").
		Save(ctx)
	if err != nil {
		return err
	}
